...
display_start_menu :- draw_menu([ 
            " ",
            "   WWWWWWWW                           WWWWWWWW                  WWWWWWW   WWWW     ",
            "   WxxxxxxW                           WxxxxxxW                  WxxxxxW  WxxxxW    ",
            "   WxxxxxxW                           WxxxxxxW                  WxxxxxW   WWWW     ",
            "   WxxxxxxW                           WxxxxxxW                  WxxxxxW            ",
            "    WxxxxxW           WWWWW           WxxxxxW   aaaaaaaaaaaaa    WxxxxW aaaaaaa    ",
            "     WxxxxxW         WxxxxxW         WxxxxxW    axxxxxxxxxxxxa   WxxxxW axxxxxa    ",
            "      WxxxxxW       WxxxxxxxW       WxxxxxW     aaaaaaaaaxxxxxa  WxxxxW  axxxxa    ",
            "       WxxxxxW     WxxxxxxxxxW     WxxxxxW               axxxxa  WxxxxW  axxxxa    ",
            "        WxxxxxW   WxxxxxWxxxxxW   WxxxxxW         aaaaaaaxxxxxa  WxxxxW  axxxxa    ",
            "         WxxxxxW WxxxxxW WxxxxxW WxxxxxW        aaxxxxxxxxxxxxa  WxxxxW  axxxxa    ",
            "          WxxxxxWxxxxxW   WxxxxxWxxxxxW        axxxxaaaaxxxxxxa  WxxxxW  axxxxa    ",
            "           WxxxxxxxxxW     WxxxxxxxxxW        axxxxa    axxxxxa  WxxxxW  axxxxa    ",
            "            WxxxxxxxW       WxxxxxxxW         axxxxa    axxxxxa WxxxxxxWaxxxxxxa   ",
            "             WxxxxxW         WxxxxxW          axxxxxaaaaxxxxxxa WxxxxxxWaxxxxxxa   ",
            "              WxxxW           WxxxW            axxxxxxxxxxaaxxxaWxxxxxxWaxxxxxxa   ",
            "               WWW             WWW              aaaaaaaaaa  aaaaWWWWWWWWaaaaaaaa   ",
            " ",
            " ",
            "1 - PLAYER VS PLAYER     ",
